 ...
 *************************************************************************
 * 
 * @file ArraysAndSequencesExample.cpp
...
bool FMainTest()
{
    ...
    char *buffer = (char*)calloc(1, as.getMaxCdrSerializedSize());
    eprosima::fastcdr::FastBuffer fbuffer(buffer, as.getMaxCdrSerializedSize());
    eprosima::fastcdr::FastCdr serializer(fbuffer);
...
bool FBug94Test()
{
    ...
    // Create the serializer object.
    char *buffer = (char*)calloc(1, ox2.getMaxCdrSerializedSize());
    eprosima::fastcdr::FastBuffer fbuffer(buffer, ox2.getMaxCdrSerializedSize());
    eprosima::fastcdr::FastCdr serializer(fbuffer);
