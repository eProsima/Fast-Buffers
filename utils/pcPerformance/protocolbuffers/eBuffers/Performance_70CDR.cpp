...
Performance_70CDR::Performance_70CDR(eProsima::CDRBuffer &cdrBuffer) : CDR(cdrBuffer)
{
}

bool Performance_70CDR::serialize(const performance::Performance &x)
{
...
bool Performance_70CDR::deserialize(performance::Performance &x)
{
    bool returnedValue = true;
