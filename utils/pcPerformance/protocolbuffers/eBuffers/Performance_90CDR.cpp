#include "Performance_90CDR.h"

Performance_90CDR::Performance_90CDR(eProsima::CDRBuffer &cdrBuffer) : CDR(cdrBuffer)
{
}

bool Performance_90CDR::serialize(const performance::Performance &x)
{
...
bool Performance_90CDR::deserialize(performance::Performance &x)
{
    bool returnedValue = true;
