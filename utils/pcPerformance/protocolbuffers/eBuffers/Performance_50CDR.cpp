#include "Performance_50CDR.h"

Performance_50CDR::Performance_50CDR(eProsima::CDRBuffer &cdrBuffer) : CDR(cdrBuffer)
{
}

bool Performance_50CDR::serialize(const performance::Performance &x)
{
...
bool Performance_50CDR::deserialize(performance::Performance &x)
{
    bool returnedValue = true;
