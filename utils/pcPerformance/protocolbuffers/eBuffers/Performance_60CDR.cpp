#include "Performance_60CDR.h"

Performance_60CDR::Performance_60CDR(eProsima::CDRBuffer &cdrBuffer) : CDR(cdrBuffer)
{
}

bool Performance_60CDR::serialize(const performance::Performance &x)
{
...
bool Performance_60CDR::deserialize(performance::Performance &x)
{
    bool returnedValue = true;
