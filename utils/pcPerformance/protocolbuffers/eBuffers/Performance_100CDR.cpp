#include "Performance_100CDR.h"

Performance_100CDR::Performance_100CDR(eProsima::CDRBuffer &cdrBuffer) : CDR(cdrBuffer)
{
}

bool Performance_100CDR::serialize(const performance::Performance &x)
{
    ...
    returnedValue &= CDR::serialize(x.m81());

    returnedValue &= CDR::serialize(x.m82());

    returnedValue &= CDR::serialize(x.m83());

    returnedValue &= CDR::serialize(x.m84());

    returnedValue &= CDR::serialize(x.m85());

    returnedValue &= CDR::serialize(x.m86());

    returnedValue &= CDR::serialize(x.m87());

    returnedValue &= CDR::serialize(x.m88());

    returnedValue &= CDR::serialize(x.m89());

    returnedValue &= CDR::serialize(x.m90());

    returnedValue &= CDR::serialize(x.m91());

    returnedValue &= CDR::serialize(x.m92());

    returnedValue &= CDR::serialize(x.m93());

    returnedValue &= CDR::serialize(x.m94());

    returnedValue &= CDR::serialize(x.m95());

    returnedValue &= CDR::serialize(x.m96());

    returnedValue &= CDR::serialize(x.m97());

    returnedValue &= CDR::serialize(x.m98());

    returnedValue &= CDR::serialize(x.m99());

    returnedValue &= CDR::serialize(x.m100());

    
    return returnedValue;
}

bool Performance_100CDR::deserialize(performance::Performance &x)
{
    bool returnedValue = true;
    ...
    returnedValue &= CDR::deserialize(x.m81());
    returnedValue &= CDR::deserialize(x.m82());
    returnedValue &= CDR::deserialize(x.m83());
    returnedValue &= CDR::deserialize(x.m84());
    returnedValue &= CDR::deserialize(x.m85());
    returnedValue &= CDR::deserialize(x.m86());
    returnedValue &= CDR::deserialize(x.m87());
    returnedValue &= CDR::deserialize(x.m88());
    returnedValue &= CDR::deserialize(x.m89());
    returnedValue &= CDR::deserialize(x.m90());
    returnedValue &= CDR::deserialize(x.m91());
    returnedValue &= CDR::deserialize(x.m92());
    returnedValue &= CDR::deserialize(x.m93());
    returnedValue &= CDR::deserialize(x.m94());
    returnedValue &= CDR::deserialize(x.m95());
    returnedValue &= CDR::deserialize(x.m96());
    returnedValue &= CDR::deserialize(x.m97());
    returnedValue &= CDR::deserialize(x.m98());
    returnedValue &= CDR::deserialize(x.m99());
    returnedValue &= CDR::deserialize(x.m100());
