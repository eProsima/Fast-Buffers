...
int main()
{
    ...
    Performance_100CDR cdr(cdrbuffer);
    performance::Performance performance;

    eProsima::CDRBuffer cdrbuffer2(buffer, BUFFER_SIZE);
    Performance_100CDR cdr2(cdrbuffer2);
    ...
    for(int count = 0; count < NUMBER_OF_LOOPS; ++count)
    {
        ...
        performance.m71(count + 71);
        performance.m72(count + 72);
        performance.m73(count + 73);
        performance.m74(count + 74);
        performance.m75(count + 75);
        performance.m76(count + 76);
        performance.m77(count + 77);
        performance.m78(count + 78);
        performance.m79(count + 79);
        performance.m80(count + 80);
        performance.m81(count + 81);
        performance.m82(count + 82);
        performance.m83(count + 83);
        performance.m84(count + 84);
        performance.m85(count + 85);
        performance.m86(count + 86);
        performance.m87(count + 87);
        performance.m88(count + 88);
        performance.m89(count + 89);
        performance.m90(count + 90);
        performance.m91(count + 91);
        performance.m92(count + 92);
        performance.m93(count + 93);
        performance.m94(count + 94);
        performance.m95(count + 95);
        performance.m96(count + 96);
        performance.m97(count + 97);
        performance.m98(count + 98);
        performance.m99(count + 99);
        performance.m100(count + 100);
