#ifndef _Performance_90_H_
#define _Performance_90_H_
...
namespace performance
{
    ...
    public:
         ...
         */
         inline
         size_t getMaxSerializedSize() { return 360;}
         ...
         */
         inline
         size_t getMaxSerializedSizeWithoutAlign(){ return 360;}
