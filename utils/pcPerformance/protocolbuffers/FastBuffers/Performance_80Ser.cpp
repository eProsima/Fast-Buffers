...
Performance_80Ser::Performance_80Ser(eProsima::FastBuffer &buffer) : FastCdr(buffer)
{
}

Performance_80Ser& Performance_80Ser::serialize(const performance::Performance &x)
{
...
Performance_80Ser& Performance_80Ser::deserialize(performance::Performance &x)
{  
