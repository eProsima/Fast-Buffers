#ifndef _Performance_70_H_
#define _Performance_70_H_
...
namespace performance
{
    ...
    public:
         ...
         */
         inline
         size_t getMaxSerializedSize() { return 280;}
         ...
         */
         inline
         size_t getMaxSerializedSizeWithoutAlign(){ return 280;}
