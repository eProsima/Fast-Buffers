#ifndef _Performance_90SER_H_
#define _Performance_90SER_H_
 ...
 */
class user_cpp_DllExport Performance_90Ser : public eProsima::FastCdr
{ 
public:
    /*!
     * @brief This constructor creates a Performance_90Ser object that could serialize/deserialize
     * the assigned buffer.
     *
     * @param buffer A reference to the buffer that contains or will contain the CDR representation.
     */
    Performance_90Ser(eProsima::FastBuffer &buffer);
    
    /*!
     * @brief This function serialize a type performance::Performance.
     * @param x Reference to a  that will be serialized in the buffer.
     * @return Reference to the Performance_90Ser object.
     ...
     */
    inline Performance_90Ser& operator<<(const performance::Performance &x){return serialize(x);}
     ...
     * @exception BadParamException This exception is thrown trying to serialize in an invalid value.
     */
    Performance_90Ser& serialize(const performance::Performance &x);
     ...
     */
    inline Performance_90Ser& operator>>(performance::Performance &x){return deserialize(x);}
     ...
     * @exception BadParamException This exception is thrown trying to deserialize in an invalid value.
     */
    Performance_90Ser& deserialize(performance::Performance &x);
};

#endif // _Performance_90SER_H_