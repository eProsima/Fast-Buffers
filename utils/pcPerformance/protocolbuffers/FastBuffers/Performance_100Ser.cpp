...
Performance_100Ser::Performance_100Ser(eProsima::FastBuffer &buffer) : FastCdr(buffer)
{
}

Performance_100Ser& Performance_100Ser::serialize(const performance::Performance &x)
{
    ...
    FastCdr::serialize(x.m91());

    FastCdr::serialize(x.m92());

    FastCdr::serialize(x.m93());

    FastCdr::serialize(x.m94());

    FastCdr::serialize(x.m95());

    FastCdr::serialize(x.m96());

    FastCdr::serialize(x.m97());

    FastCdr::serialize(x.m98());

    FastCdr::serialize(x.m99());

    FastCdr::serialize(x.m100());

    
    return *this;
}

Performance_100Ser& Performance_100Ser::deserialize(performance::Performance &x)
{  
    ...
    FastCdr::deserialize(x.m91());
    FastCdr::deserialize(x.m92());
    FastCdr::deserialize(x.m93());
    FastCdr::deserialize(x.m94());
    FastCdr::deserialize(x.m95());
    FastCdr::deserialize(x.m96());
    FastCdr::deserialize(x.m97());
    FastCdr::deserialize(x.m98());
    FastCdr::deserialize(x.m99());
    FastCdr::deserialize(x.m100());
