#ifndef _Performance_50_H_
#define _Performance_50_H_
...
namespace performance
{
    ...
    public:
         ...
         */
         inline
         size_t getMaxSerializedSize() { return 200;}
         ...
         */
         inline
         size_t getMaxSerializedSizeWithoutAlign(){ return 200;}
