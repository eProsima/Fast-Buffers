#include "Performance_70Ser.h"
#include "cdr/exceptions/BadParamException.h"

Performance_70Ser::Performance_70Ser(eprosima::FastBuffer &buffer) : FastCdr(buffer)
{
}

Performance_70Ser& Performance_70Ser::serialize(const performance::Performance &x)
{
...
Performance_70Ser& Performance_70Ser::deserialize(performance::Performance &x)
{  
