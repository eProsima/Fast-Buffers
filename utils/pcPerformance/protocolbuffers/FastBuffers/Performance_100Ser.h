#ifndef _Performance_100SER_H_
#define _Performance_100SER_H_
 ...
 */
class user_cpp_DllExport Performance_100Ser : public eprosima::FastCdr
{ 
public:
    /*!
     * @brief This constructor creates a Performance_100Ser object that could serialize/deserialize
     * the assigned buffer.
     *
     * @param buffer A reference to the buffer that contains or will contain the CDR representation.
     */
    Performance_100Ser(eprosima::FastBuffer &buffer);
    
    /*!
     * @brief This function serialize a type performance::Performance.
     * @param x Reference to a  that will be serialized in the buffer.
     * @return Reference to the Performance_100Ser object.
     ...
     */
    inline Performance_100Ser& operator<<(const performance::Performance &x){return serialize(x);}
     ...
     * @exception BadParamException This exception is thrown trying to serialize in an invalid value.
     */
    Performance_100Ser& serialize(const performance::Performance &x);
     ...
     */
    inline Performance_100Ser& operator>>(performance::Performance &x){return deserialize(x);}
     ...
     * @exception BadParamException This exception is thrown trying to deserialize in an invalid value.
     */
    Performance_100Ser& deserialize(performance::Performance &x);
};

#endif // _Performance_100SER_H_